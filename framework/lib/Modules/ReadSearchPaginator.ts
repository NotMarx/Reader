...
export async function createReadSearchPaginator(client: NReaderClient, book: Book, interaction: CommandInteraction<TextableChannel>) {
    const paginator = new ReadSearchPaginator(client, book, interaction);
